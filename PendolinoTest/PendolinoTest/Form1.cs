...
namespace PendolinoTest
{
    public partial class Form1 : Form
    {
        ...
        {
            koshiClientUI.IpAddress = Properties.Settings.Default.IpAddress;
            koshiClientUI.PortNumber = Properties.Settings.Default.PortNumber;
        }
        private void Form1_FormClosing(object sender, FormClosingEventArgs e)
        {
            Properties.Settings.Default.IpAddress = koshiClientUI.IpAddress;
            Properties.Settings.Default.PortNumber = koshiClientUI.PortNumber;
        ...
        private void trackTheta0_Scroll(object sender, EventArgs e)
        {
            ...
            if (sw.ElapsedMilliseconds > 100)
            {
                koshiClient.uartWrite("#t" + Th0.ToString() + "$");
                sw.Restart();
            }
        }
